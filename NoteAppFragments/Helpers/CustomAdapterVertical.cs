...
{
    class CustomAdapterVertical : BaseAdapter<Note>
    {
        private readonly Activity _context;
        private readonly List<Note> _items;

        public CustomAdapterVertical(Activity context, List<Note> items)
        {
            _items = items;
            _context = context;
        }
        ...
        {
            var view = convertView ?? _context.LayoutInflater.Inflate(Resource.Layout.customrow_vertical, null);
